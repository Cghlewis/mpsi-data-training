...
5. Combine datasets to gain new insights (IES).

Similar to collaboration, sharing your data provides the opportunity to combine datasets across studies, allowing new discoveries. Combining datasets may also help those who have datasets with low-statistical power, and without combining datasets, are unable to answer questions of interest ([Logan, Hart & Schatschneider](https://edarxiv.org/2x3cu/)).
...
Sharing data encourages diversity of analysis and opinions. Other researchers may have novel questions that can answer with your data that you have never considered. 
