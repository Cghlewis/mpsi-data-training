...
There are many reasons to consider sharing your research study data. Ten compelling reasons are listed below.
...
NIH:
 ...
 📑 [NIH DMSP Guidance for Data Support Services Working Group](https://osf.io/awypt)
...
5. Types and Formats of Data Accepted
...
Currently there are very few education specific repositories. Both [LDbase](https://www.ldbase.org/) and [ICPSR](https://www.icpsr.umich.edu/web/pages/deposit/index.html) are recommended by IES. LDbase being truly for education researchers, and ICPSR being a little more general, for social sciences. There are many general repository options though. A few well-known ones include [Harvard DataVerse](https://dataverse.harvard.edu/), [Dryad](https://datadryad.org/stash), [OSF](https://osf.io/), [Zenodo](https://zenodo.org/), and [FigShare](https://figshare.com/).
...
+ You want your consent language to discuss confidentiality but also mention that there are still risks.
    ...
    - If your consent form does not warn about the possibility of re-identification then, in addition to removing direct identifiers from your data, you will need to really consider small sample sizes and combinations of variables that might allow some to re-identify a participant.  
...
+ Refer back to [Module 2](https://cghlewis.github.io/mpsi-data-training/training_2.html) for Meyer's dos and don'ts of consent form language.
...
+ The fourth level is an **analytic file**. While people use this term in different ways, what I am referring to here is a file prepared for a specific analysis that is based on the aforementioned cleaned data file. These are files that begin as the cleaned data file mentioned above and then may be further reduced in size (either in cases and/or columns), and may have additional transformations that are *created solely for the purpose of a specific analysis*. You can think of this as a file used as the basis of a specific publication. While I do recommended this file to be shared as well, I view this as a secondary source, shared for the purposes of allowing replication of your study, rather than for the purposes of people using your data for their own future analyses.
...
* **Data Use Agreements** are legally binding formal agreements (contract) used when sharing data with restricted access. [Florida State University](https://www.ldbase.org/resources/best-practices/data-use-vs-data-sharing) has an example of a DUA here. 
  ...
  * And the user is typically also required to provide the following information:
...
Similar to what we discussed in [Module 1](https://cghlewis.github.io/mpsi-data-training/training_1.html#Metadata), documentation can be categorized into 3 different types of metadata. Consider sharing something from each of these categories to give users the best overview of your project and how to use your data.
...
This documentation provides a big picture sense of what datasets are included in the project and how they are connected. The type of dataset level documentation to consider including when data sharing is a README. As discussed in [Module 1](https://cghlewis.github.io/mpsi-data-training/training_1.html#README), a README is a plain text document that can serve many purposes. It literally is an indicator to users to "Read Me" before moving forward with this data. In the context of data sharing, your README should include things such as:
...
**Note:** These terms are often interchangeable. You will notice that in the [IES Data Sharing Study Data Guide](https://ies.ed.gov/ncee/pubs/2022004/pdf/2022004.pdf), they refer to a Codebook as as Summary Statistics Document and they refer to a Data Dictionary as a Codebook. Depending on what organization you work with, different terms may be used, but the ideas are all still the same. 
...
If you have used your data in a publication, you will also need to consider retracting the paper from the journal. Contact your journal to make them aware of the errors you found. Consider the story of [Dr. Kate Laskowski](https://laskowskilab.faculty.ucdavis.edu/2020/01/29/retractions/), who began finding errors in her data, after publishing with it, and decided she had no other choice but to retract her publication. You can find the retracted article [here](https://www.journals.uchicago.edu/doi/full/10.1086/708066?mobileUi=0).
