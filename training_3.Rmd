...
project <- Node$new("project-new")
  ...
  projectmgmt <- project$AddChild("project-mgmt")
    protocols <- projectmgmt$AddChild("protocols")
...
1. Keep names under 45 characters (this is excessive, many people will recommend shorter names)
...
1. Examples of this format:
    ...
    - `dsc_c1_tch_svy_data_raw_2020-08-03.csv`
