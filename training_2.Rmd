...
There are many other ways to load data into a database but for this use case (tracking participation in an education research study) I am only covering these two methods. However, you can read about several other methods [here](https://www.quackit.com/database/tutorial/adding_data_to_database.cfm). 

Also, most recently I've heard people mention the idea of automating at least some data entry/tracking through the use of unique scannable QR codes for instance on paper data **or** through a connection/integration between your online data collection platform and your tracking database (ex: [Qualtrics and Quick Base](https://www.workato.com/integrations/quickbase+qualtrics)). This type of linking would require your database to be cloud based and most likely requires some technical skills to set up this linking process. But it's a cool idea! For example, using unique QR codes, similar to what is used for [tracking inventory](https://blog.beaconstac.com/2020/07/qr-codes-for-inventory-management/), you could scan a QR code on a survey when it comes back from data collection and "check it in" to your participant database under their ID. Or by integrating your survey platform and participant database, you could add new participants to your database as they complete their consents and surveys online.
