...
* Data collection
  * How to create necessary materials
  * Tools used
  * Actual collection steps
  * Correspondence and reminders
* Staff training (also temporary hiring)
* Data entry, data retrieval, data scoring
* Payments/Incentives
* Intervention implementation

Each protocol should begin with the following to track project changes:
...
Additional metadata information can be found here:  
  ...
  📑 [Metadata: Oregon State](https://guides.library.oregonstate.edu/research-data-services/data-management-metadata#:~:text=Project%2Dlevel%20metadata%20describes%20the,Dataset%20title)  
  📑 [Metadata: UCI](https://guides.lib.uci.edu/datamanagement/describe)    
  📑 [Metadata: NCSU](https://www.lib.ncsu.edu/do/data-management/metadata)  
  📑 [Qualitative Metadata: IHEID](https://libguides.graduateinstitute.ch/rdm/qualitative)  
  📑 [Metadata for archiving: ICPSR](https://www.icpsr.umich.edu/web/pages/datamanagement/dmp/plan.html)   
  📑 [Project level metadata Example: DDI](https://ddialliance.org/training/getting-started/data-catalog)  
  📑 [Types of Metadata: ADS](https://guides.archaeologydataservice.ac.uk/g2gp/CreateData_1-2#ref-CreateData_1-2-9)  
...
* You received a demographics file from a school district
  + When did you receive this, Why did you receive this
    + That school district sends you an updated version of that file 3 weeks later
