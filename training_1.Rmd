...
It is also possible to have protocol that may be applicable across all projects (such as rules for data entry). While these kinds of protocols should go in your project specific protocol for documentation, you can also keep a copy of these more broad rules in an institutional protocol (or some may call it a lab manual) to be referred to for all projects.
...
* Group variables by measure (Student survey, teacher rating of student, etc.) 
...
Additional reading on data dictionaries can be found here:
  ...
  📑 [Education Data Done Right](file:///C:/Users/HAMPTO~1/AppData/Local/Temp/eddatadoneright.pdf)
...
Additional metadata information can be found here:  
  ...
  📑 [DMP Tool](https://dmptool.org/general_guidance)  
