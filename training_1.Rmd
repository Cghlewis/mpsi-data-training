...
I am including wiki in here, even though I think it is an unconventional tool in education research. A wiki is not something that you will share with others outside of your research team, but it is a tool that can help your team internally document, organize, and navigate frequently used information. If you use platforms such as Microsoft SharePoint, a wiki can be a great place to store high level information that your team frequently refers to. SharePoint describes a wiki as "a site that is designed for groups of people to quickly capture and share ideas by creating simple pages and linking them together." It is a page that anyone on your team can add/edit content and then can link to those referenced documents for easy access. 
