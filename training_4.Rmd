...
**1\.** A colleague is in charge of cleaning data for project x. At the end of a data collection wave, the colleague sends you clean data. Yet when reviewing it you find three small errors in the data they send you.   
